...
class TopicButtonAreaView: UIView, GridLayout, ReloadableView {
    ...
    private func sharedInit() {
        ...
        playButton.roundBorder(borderWidth: 0, cornerRadius: step, color: .clear)
        ...
        topViewSwitchButton.roundBorder(borderWidth: 0, cornerRadius: step, color: .clear)
        topViewSwitchButton.setIconImage(named: "baseline_style_black_\(isIPad ? "48pt" : "36pt")", title: "", tintColor: .black, isIconOnLeft: false)
        ...
        repeatOneSwitchButton.setIconImage(named: "baseline_repeat_one_black_\(isIPad ? "48pt" : "24pt")", title: "", tintColor: .white, isIconOnLeft: false)
